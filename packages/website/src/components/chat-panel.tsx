...
import type { GameMessageRecord } from '@/lib/game/types';
...
export function ChatPanel({ gameId, initialMessages, initialBalance }: ChatPanelProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between rounded-xl bg-zinc-100 px-4 py-3 text-sm text-zinc-600">
        <span>当前余额</span>
