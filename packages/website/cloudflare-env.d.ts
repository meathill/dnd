/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 636d0104565bda6d51494a147f31834d)
...
declare namespace Cloudflare {
  interface Env {
    ...
    ASSETS: Fetcher;
    NEXT_PUBLIC_ASSET_URL: 'https://idnd.roudan.io';
    NEXT_PUBLIC_SITE_URL: 'https://dndcoc.meathill.com';
    NEXTJS_ENV: string;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'NEXT_PUBLIC_ASSET_URL' | 'NEXT_PUBLIC_SITE_URL' | 'NEXTJS_ENV' | 'OPENAI_API_KEY' | 'GEMINI_API_KEY'
      >
    > {}
}
