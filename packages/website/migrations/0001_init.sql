...
INSERT INTO scripts (
  ...
  '{"overview":"","truth":"","themes":[],"factions":[],"locations":[],"explorableAreas":[{"id":"area-yard","name":"老宅院子","summary":"暴雨冲刷的碎符与盐圈残迹。","description":"破旧围栏半塌，树影在闪电中摇晃，泥地上还能看见未被雨水洗净的符纸灰。","dmNotes":"提示符纸被撕裂是有人闯入时所为。"},{"id":"area-foyer","name":"正门与门廊","summary":"木门被木板钉死，烛光从门缝渗出。","description":"门廊上堆着旧箱子与断裂木板，门锁锈蚀但还算完整。","dmNotes":"破门或开锁均可进入，但会制造噪音。"},{"id":"area-hall","name":"一层走廊","summary":"空气潮湿，地面有拖拽痕。","description":"通向起居室与楼梯口，墙上挂着褪色的家族照片。","dmNotes":"拖拽痕可指向地下室入口。"},{"id":"area-basement","name":"地下祈祷室","summary":"盐圈与刻痕围出祭坛。","description":"墙面刻满祷文与抓痕，孩童的哭声从黑暗深处传来。","dmNotes":"邪灵在此地现形，战斗或驱魔关键场景。"}],"secrets":[]}',
  '[]',
  '[]',
  '{}'
)
...
INSERT INTO scripts (
  ...
  '{"overview":"竹影装潢是一家装修工作室，实际由风水师接手凶宅驱邪后转手出售。","truth":"本次凶宅的“闹鬼”源自前租户意外死亡留下的怨念与阵眼破损。","themes":["职场试炼","民俗与科学","隐秘交易"],"factions":["竹影装潢","物业与房东","附近居民"],"locations":["竹影装潢工作室","青藤巷 17 号","邻里便利店"],"explorableAreas":[{"id":"area-studio","name":"竹影装潢工作室","summary":"工具与符纸堆满的入门现场。","description":"艾草味混着木屑味，墙上挂着施工日程与祈福符。","dmNotes":"林砚会在此交代任务。"},{"id":"area-alley","name":"青藤巷 17 号","summary":"凶宅外墙斑驳，门锁却崭新。","description":"封条残破，雨水从楼道窗缝渗下。","dmNotes":"邻居可能提供线索。"},{"id":"area-store","name":"邻里便利店","summary":"附近居民聚集的消息站。","description":"老板娘对凶宅传闻极为敏感。","dmNotes":"可获得过去事故消息。"},{"id":"area-crawlspace","name":"墙体暗格","summary":"阵眼破损处，阴冷气息最重。","description":"铜钱线断裂，符纸潮湿发黑。","dmNotes":"触发怨念显形。"}],"secrets":["师父并未全盘告知你本次交易的真实利润","林砚其实在测试你是否能承受灵异冲击","阵眼被人为破坏，可能有人想赶走灵异以压价收房"]}',
  '[
