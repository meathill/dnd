/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --strict-vars false ./cloudflare-env.generated.d.ts` (hash: 6e2bd2deee76725694546f69f1e303d0)
...
declare namespace Cloudflare {
	interface Env {
		...
		PLAY_RUNTIME: string;
		PLAY_LLM_MODEL: string;
		WORKER_SELF_REFERENCE: Fetcher /* muirpg-play */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLAY_BASE_URL" | "WEBSITE_BASE_URL" | "PLAY_RUNTIME" | "PLAY_LLM_MODEL">> {}
}
